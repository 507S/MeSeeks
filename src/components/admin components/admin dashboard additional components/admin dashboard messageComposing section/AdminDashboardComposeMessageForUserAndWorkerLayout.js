...
export default function AdminDashboardComposeMessageForUserAndWorkerLayout() {
        ...
        <div className="row">
          ...
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              {/* //button test */}
              <AdminDashboardHeaderContent adminHeaderContentText="Compose Message" />
              ...
              <div class=" card-body w-100" style={{ height: "auto" }}>
                ...
                <AdminDashboardActionForm method="POST">
                  <SelectAreaInput
                    ...
                    value="User"
                    labelName="Select Recipient :"
                  />
                  <TextInput
                    name="name"
                    labelName="Recipient ID : "
                    type="text"
                  ...
                  <div class="col-md-4 col-lg-2 w-100 ">
                    <AdminDashboardActionButton
                      ...
                      adminActionButtonIcon="fa fa-send"
                      adminActionButtonText="Send Message"
                      type="submit"
                      value="Submit"
                      onClick={addinpdata}
                    />
