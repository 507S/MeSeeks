...
import WarningImage from "../../../../assets/worker assets/images/warning.png";
...
export default function WorkerDashboardWarningMessageListLayout() {
  return (
    <>
          ...
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              ...
              <WorkerDashboardHeaderContent
                adminHeaderContentText="Warning Messages"
            ...
            {/* <div className="container">
              ...
              <div class=" card-body w-100" style={{ height: "auto" }}>
                ...
                <WorkerDashboardActionForm method="GET">
                  ...
                  <h5>Message received : {"Timestamp"} <img src={WarningImage} width="50px" height="50px" style={{float:"right"}} alt="admin"  /> </h5>
                  
                  <TextAreaInput
                    labelName="Warning Message "
                    placeholder=""
                    // value={inpval.msg}
                    // onChange={setdata}
