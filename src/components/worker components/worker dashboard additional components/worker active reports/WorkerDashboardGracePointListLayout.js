...
export default function WorkerDashboardGracePointListLayout() {
  return (
    <>
          ...
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              ...
              <WorkerDashboardHeaderContent
                adminHeaderContentText="Grace Point List"
                workerDashboardHeaderContentImage="fa-solid fa-medal "
              />
                  ...
                  <WorkerDashboardDataTableLayout className="table table-striped table-sm">
                    ...
                    <thead>
                      <tr>
                        ...
                        <WorkerDashboardDataTableColumnHeaderContent
                          tableColumnClassName="col"
                          tableColumnHeaderText="Rating"
                        />
                        <WorkerDashboardDataTableColumnHeaderContent
                          tableColumnClassName="col"
                          tableColumnHeaderText="Grace Point"
                        />
                      </tr>
                    </thead>
